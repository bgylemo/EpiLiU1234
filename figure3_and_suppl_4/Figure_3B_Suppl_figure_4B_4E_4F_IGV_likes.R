...
txdb <- loadDb("/media/colne37/hippopotamus/thymodevel/annotation_data/txdb.hg38.refGene.sqlite")
...
#melt_df_beta_median_anno_chrx <- melt_df_beta_median_anno[melt_df_beta_median_anno$CHR_hg38 == "chrX",]
...
pdf(file = paste("/media/colne37/hippopotamus/thymodevel/plots/figure_3B_and_suppl_figure_4B_4F/", i, ".pdf", sep=""), height = 10, width = 12)
...
ggsave2(filename = "/media/colne37/hippopotamus/thymodevel/plots/figure_3B_and_suppl_figure_4B_4F/Figure_3B_and_suppl_figure_4B_methylation_and_TPM.pdf", height = 14, width = 6,
        plot_grid(ncol=2,
                  tpmzzz, methhh)
)
